...
const Productsdetails = () => {
  ...
  <button style={{width:"350px", height:"50px", fontSize:"20px", borderRadius:"30px", marginTop:"30px", marginLeft:"250px",backgroundColor:"transparent", color:"black", borderColor:"black"}}>Favourite <FontAwesomeIcon icon={faHeart} /></button>
  </div>
